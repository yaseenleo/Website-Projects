        ...
        return (
            <form onSubmit={this.handleSubmit}>
                <div className="row">
                    ...
                    <div className="col-12">
                        <select className="form-control form-select" name="service" onChange={this.onChangeHandler} value={this.state.service} required>
...
if (document.getElementById('popup_query')) {
    createRoot(
        document.getElementById('popup_query')
    ).render(
        <Contact />
    );
}
